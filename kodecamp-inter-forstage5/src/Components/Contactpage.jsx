...
const Contactpage = () => {
  const [contacts, setContacts] = useState([
    {name:'Chillycee Stores', street:'12 ijewere Aguda Surulere, Lagos State', phone:'+2348083346290', email:'info@chillyceestores.com',  id:1},
    {name:'Chillycee Stores', street:'35 Evo Road GRA, Portharcourt, Rivers State', phone:'+2347030572635', email:'info@chillyceestores.com', id:2}
  ]);
  return (
        ...
        <div>
          ...
          <div className="row container">
            <div className="col-md-4 col-sm-12 pt-3">
              <a href='www.facebook.com' className='text-decoration-none pe-4'>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="black" class="bi bi-meta" viewBox="0 0 16 16">
              ...
              <a href='www.instagram.com' className='text-decoration-none pe-4'>
              ...
              <a href='www.twitter.com' className='text-decoration-none pe-4'>
              ...
              <a href='https://api.whatsapp.com/send?phone=2347030572635' >
